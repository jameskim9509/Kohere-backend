...
| [`listing`](#3-listing--매물-탐색찜) | `Listing`, `Favorite`, `RecentListing` | `GeoPoint`, `Address`, `Contact`, `RoomOffer`, `MatchedPlace` | ✅ |
...
| `roomOffers` | `List<RoomOffer>` | 가격·계약기간·검색 태그가 같은 실제 방 묶음 |
