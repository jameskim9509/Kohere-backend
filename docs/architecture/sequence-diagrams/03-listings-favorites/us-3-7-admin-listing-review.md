...
sequenceDiagram
    ...
    alt 심사 대상 아님 (PUBLISHED · REJECTED)
        LIST-->>W: 409 LISTING_INVALID_STATUS_TRANSITION
        Note over LIST: 재심사는 임대인이 수정해 PENDING으로<br/>되돌린 뒤에만 가능하다(후속 이슈)
    else PENDING
